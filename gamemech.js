		...
		if (gameVariables.paused === false) {
			if (hero.death === 0 && missionArray[13][0].completed === 'no') {
				...
				if (38 in keysDown || 87 in keysDown) {
					// Player holding up - moving forward
					//runningAnimation();
					if (hero.walking === 1) {
					...
					newPositionBackward(gameDisplay, hero, 0);
					newPositionBackward(tileDisplay, hero, 0);
					for (u = 0; u < gameArrays.monsterArray.length; u++) {
						newPositionForwardMonster(gameArrays.monsterArray[u], hero, 0);
					}
					for (k = 0; k < gameArrays.archivedMonsterArray.length; k++) {
						newPositionForward(gameArrays.archivedMonsterArray[k], hero, 0);
					}
					for (p = 0; p < gameArrays.treeAndHouseArray.length; p++) {
						newPositionForwardEnvironment(gameArrays.treeAndHouseArray[p], hero, 0);
					}
					for (o = 0; o < gameArrays.objectArray.length; o++) {
						newPositionForward(gameArrays.objectArray[o], hero, 0);
					}
					for (b = 0; b < gameArrays.rocketArray.length; b++) {
						newPositionForward(gameArrays.rocketArray[b], hero, 0);
					}
					for (p = 0; p < gameArrays.environmentArray.length; p++) {
						newPositionForwardEnvironment(gameArrays.environmentArray[p], hero, 0);
					}
					for (n = 0; n < gameArrays.thrownGranadeArray.length; n++) {
						newPositionForward(gameArrays.thrownGranadeArray[n], hero, 0);
					}
					for (u = 0; u < missionArray.length; u++) {
						if (missionArray[u][0].type === 'find' || missionArray[u][0].type === 'interact') {
							newPositionForward(missionArray[u][0], hero, 0);
						}
					}
					for (h = 0; h < gameArrays.numberOfLampsOnScreen.length; h++) {
						newPositionForward(gameArrays.numberOfLampsOnScreen[h], hero, 0);
						newPositionForwardShadow(gameArrays.numberOfLampsOnScreen[h], hero, 0);
					}
					for (h = 0; h < gameArrays.backgroundArray.length; h++) {
						...
						newPositionForward(gameArrays.backgroundObjectArray[h], hero, 0);
					}
					for (f = 0; f < gameArrays.bulletArray.length; f++) {
						//document.getElementById("testdiv").innerHTML = document.getElementById("testdiv").innerHTML + "<br />" + "updating pos UP";
						bulletTraceMovingForward(gameArrays.bulletArray[f], hero, 0);
					}
				} else {
				...
				if (40 in keysDown || 83 in keysDown) {
					// Player holding down -  moving backwards
					//runningAnimation();
					if (hero.walking === 1) {
					...
					newPositionForward(gameDisplay, hero, 0);
					newPositionForward(tileDisplay, hero, 0);
					for (u = 0; u < gameArrays.monsterArray.length; u++) {
						newPositionBackwardMonster(gameArrays.monsterArray[u], hero, 0);
					}
					for (k = 0; k < gameArrays.archivedMonsterArray.length; k++) {
						newPositionBackward(gameArrays.archivedMonsterArray[k], hero, 0);
					}
					for (p = 0; p < gameArrays.treeAndHouseArray.length; p++) {
						newPositionBackwardEnvironment(gameArrays.treeAndHouseArray[p], hero, 0);
					}
					for (o = 0; o < gameArrays.objectArray.length; o++) {
						newPositionBackward(gameArrays.objectArray[o], hero, 0);
					}
					for (b = 0; b < gameArrays.rocketArray.length; b++) {
						newPositionBackward(gameArrays.rocketArray[b], hero, 0);
					}
					for (p = 0; p < gameArrays.environmentArray.length; p++) {
						newPositionBackwardEnvironment(gameArrays.environmentArray[p], hero, 0);
					}
					for (n = 0; n < gameArrays.thrownGranadeArray.length; n++) {
						newPositionBackward(gameArrays.thrownGranadeArray[n], hero, 0);
					}
					for (u = 0; u < missionArray.length; u++) {
						if (missionArray[u][0].type === 'find' || missionArray[u][0].type === 'interact') {
							newPositionBackward(missionArray[u][0], hero, 0);
						}
					}
					for (h = 0; h < gameArrays.numberOfLampsOnScreen.length; h++) {
						newPositionBackward(gameArrays.numberOfLampsOnScreen[h], hero, 0);
						newPositionBackwardShadow(gameArrays.numberOfLampsOnScreen[h], hero, 0);
					}
					for (h = 0; h < gameArrays.backgroundArray.length; h++) {
						//document.getElementById("testdiv").innerHTML = document.getElementById("testdiv").innerHTML + "<br />" + "updating pos DOWN";
						newPositionBackward(gameArrays.backgroundObjectArray[h], hero, 0);
					}
					for (f = 0; f < gameArrays.bulletArray.length; f++) {
						//document.getElementById("testdiv").innerHTML = document.getElementById("testdiv").innerHTML + "<br />" + "updating pos DOWN";
						bulletTraceMovingBackward(gameArrays.bulletArray[f], hero, 0);
					}
				...
				if (37 in keysDown || 65 in keysDown) {
					...
					newPositionBackward(gameDisplay, hero, -90);
					newPositionBackward(tileDisplay, hero, -90);
					for (u = 0; u < gameArrays.monsterArray.length; u++) {
						newPositionForwardMonster(gameArrays.monsterArray[u], hero, -90);
					}
					for (p = 0; p < gameArrays.treeAndHouseArray.length; p++) {
						newPositionForwardEnvironment(gameArrays.treeAndHouseArray[p], hero, -90);
					}
					for (o = 0; o < gameArrays.objectArray.length; o++) {
						newPositionForward(gameArrays.objectArray[o], hero, -90);
					}
					for (b = 0; b < gameArrays.rocketArray.length; b++) {
						newPositionForward(gameArrays.rocketArray[b], hero, -90);
					}
					for (p = 0; p < gameArrays.environmentArray.length; p++) {
						newPositionForwardEnvironment(gameArrays.environmentArray[p], hero, -90);
					}
					for (n = 0; n < gameArrays.thrownGranadeArray.length; n++) {
						newPositionForward(gameArrays.thrownGranadeArray[n], hero, -90);
					}
					for (u = 0; u < missionArray.length; u++) {
						if (missionArray[u][0].type === 'find' || missionArray[u][0].type === 'interact') {
							newPositionForward(missionArray[u][0], hero, -90);
						}
					}
					for (h = 0; h < gameArrays.numberOfLampsOnScreen.length; h++) {
						newPositionForward(gameArrays.numberOfLampsOnScreen[h], hero, -90);
						newPositionForwardShadow(gameArrays.numberOfLampsOnScreen[h], hero, -90);
					}
					for (h = 0; h < gameArrays.backgroundArray.length; h++) {
						//document.getElementById("testdiv").innerHTML = document.getElementById("testdiv").innerHTML + "<br />" + "updating pos UP";
						newPositionForward(gameArrays.backgroundObjectArray[h], hero, -90);
					}
					for (f = 0; f < gameArrays.bulletArray.length; f++) {
						//document.getElementById("testdiv").innerHTML = document.getElementById("testdiv").innerHTML + "<br />" + "updating pos UP";
						bulletTraceMovingForward(gameArrays.bulletArray[f], hero, -90);
					} */
					// Player holding left
					/* if (hero.walking === 1) {
						hero.angle -= 1;
				...
				//Shot
				if (
					(32 in keysDown && gameVariables.hasFired === 0) ||
				...
				ambushMissionSpawn(
					...
					gameVariables.timeControler,
					missionArray,
					gameArrays.monsterArray,
					gameArrays.granadeArray,
					gameArrays.rocketArray
				);
					...
					for (l = 0; l < gameArrays.monsterArray.length; l++) {
						try {
							if (gameArrays.bulletArray[i].firedFrom != 'slime' && gameArrays.bulletArray[i].firedFrom != 'bile') {
								...
								if (
									(gameArrays.bulletArray[i].bulletX - gameArrays.monsterArray[l].x) *
										(gameArrays.bulletArray[i].bulletX - gameArrays.monsterArray[l].x) +
										(gameArrays.bulletArray[i].bulletY - gameArrays.monsterArray[l].y) *
											(gameArrays.bulletArray[i].bulletY - gameArrays.monsterArray[l].y) <
									15 * 15
								) {
									...
									if (gameArrays.monsterArray[l].health - gameArrays.bulletArray[i].bulletDamage > 0) {
										gameArrays.monsterArray[l].health =
											gameArrays.monsterArray[l].health - gameArrays.bulletArray[i].bulletDamage;
										if (
											gameArrays.monsterArray[l].state != 'attacking' ||
								...
								if (gameArrays.bulletArray[i].firedFrom === 'slime') {
									if (
										(gameArrays.bulletArray[i].bulletX - 400) * (gameArrays.bulletArray[i].bulletX - 400) +
											(gameArrays.bulletArray[i].bulletY - 300) * (gameArrays.bulletArray[i].bulletY - 300) <
										15 * 15
									) {
				...
				for (v = 0; v < gameArrays.objectArray.length; v++) {
					if (
						hero.x <= gameArrays.objectArray[v].x + 15 &&
						gameArrays.objectArray[v].x <= hero.x + 15 &&
						hero.y <= gameArrays.objectArray[v].y + 15 &&
						gameArrays.objectArray[v].y <= hero.y + 15
					) {
						...
						if (gameArrays.objectArray[v].name === 'survivor') {
							...
							if (hero.currentMission === 4) {
								...
								if (
									gameArrays.objectArray[v].name === 'Elderweed' &&
									missionArray[9][1].gathered < missionArray[9][1].amount
								) {
									missionArray[9][1].gathered = missionArray[9][1].gathered + 1;
								} else if (
									gameArrays.objectArray[v].name === 'Zombie excrement' &&
									missionArray[9][2].gathered < missionArray[9][2].amount
								) {
									missionArray[9][2].gathered = missionArray[9][2].gathered + 1;
								} else if (
									gameArrays.objectArray[v].name === 'Butterfly eggs' &&
									missionArray[9][3].gathered < missionArray[9][3].amount
								) {
							...
							inventory[gameArrays.objectArray[v].imageSource].amount =
								parseInt(inventory[gameArrays.objectArray[v].imageSource].amount) +
								parseInt(gameArrays.objectArray[v].amount);
				...
				for (b = 0; b < gameArrays.monsterArray.length; b++) {
					if (
						hero.x <= gameArrays.monsterArray[b].x + 30 &&
						gameArrays.monsterArray[b].x <= hero.x + 30 &&
						hero.y <= gameArrays.monsterArray[b].y + 30 &&
						gameArrays.monsterArray[b].y <= hero.y + 30
					) {
						if (gameArrays.monsterArray[b].attackIni === 0) {
							...
							gameArrays.monsterArray[b].attackTime.setMilliseconds(
								gameVariables.timeControler.getMilliseconds() + gameArrays.monsterArray[b].damageInterval
							);
							//console.log("Starting " + gameVariables.timeControler.getTime() + " " + gameArrays.monsterArray[b].attackTime.getTime());
						} else if (
							gameArrays.monsterArray[b].attackIni === 1 &&
							gameVariables.timeControler.getTime() >= gameArrays.monsterArray[b].attackTime.getTime()
						) {
				...
				mapControl(
					...
					gzImagesLoaded,
					farmImagesLoaded,
					basecampImagesLoaded,
					gameArrays.environmentArray,
					gameArrays.objectArray,
					gameArrays.treeAndHouseArray,
					treeImagesLoaded
				);
	...
	var render = function () {
		...
		if (bgReady) {
			...
			for (y = 0; y < gameArrays.backgroundArray.length; y++) {
				ctx.drawImage(
					gameArrays.backgroundArray[y],
					gameArrays.backgroundObjectArray[y].x,
					gameArrays.backgroundObjectArray[y].y,
					canvas.width,
					canvas.height
				);
			}
		...
		for (h = 0; h < gameArrays.environmentArray.length; h++) {
			...
			/* 			ctx.fillText(
				'Number ' + h,
				gameArrays.environmentArray[h].targetX + 380,
				gameArrays.environmentArray[h].targetY + 300
			); */
			ctx.drawImage(
				gameArrays.environmentArray[h],
				gameArrays.environmentArray[h].targetX,
				gameArrays.environmentArray[h].targetY,
				1024,
				768
			);
			...
			for (j = 0; j < gameArrays.monsterArray.length; j++) {
				...
				if (gameArrays.monsterArray[j].skin === 1) {
					if (gameArrays.monsterArray[j].state === 'idle') {
						drawRotatedMonster(
							monsterImageIdle1,
							gameArrays.monsterArray[j].x,
							gameArrays.monsterArray[j].y,
							gameArrays.monsterArray[j].angle - 180,
							30,
							30,
							gameArrays.monsterArray[j].state
						);
					} else {
						drawRotatedMonster(
							monsterImage1,
		...
		for (g = 0; g < gameArrays.bulletArray.length; g++) {
			if (gameArrays.bulletArray[g].firedFrom === 'flamethrower') {
				if (
					Math.sqrt(
						Math.pow(gameArrays.bulletArray[g].bulletX - hero.x, 2) +
							Math.pow(gameArrays.bulletArray[g].bulletY - hero.y, 2)
					) > 150
				) {
		...
		for (u = 0; u < gameArrays.treeAndHouseArray.length; u++) {
			...
			drawRotatedTree(
				gameArrays.treeAndHouseArray[u],
				gameArrays.treeAndHouseArray[u].targetX,
				gameArrays.treeAndHouseArray[u].targetY,
				gameArrays.treeAndHouseArray[u].angle,
				gameArrays.treeAndHouseArray[u].width,
				gameArrays.treeAndHouseArray[u].height
			);
		}
		...
		if (lampReady && gameVariables.missionType === 'Poles') {
			for (y = 0; y < gameArrays.numberOfLampsOnScreen.length; y++) {
				if (gameArrays.numberOfLampsOnScreen[y].on === 1) {
					ctx.drawImage(
						lampImage,
						gameArrays.numberOfLampsOnScreen[y].x,
						gameArrays.numberOfLampsOnScreen[y].y,
						gameArrays.numberOfLampsOnScreen[y].radius,
						gameArrays.numberOfLampsOnScreen[y].radius
					);
					drawTileShadow(
						gameArrays.numberOfLampsOnScreen[y].tileStartPointX,
						gameArrays.numberOfLampsOnScreen[y].tileStartPointY,
						gameArrays.numberOfLampsOnScreen[y].x,
						gameArrays.numberOfLampsOnScreen[y].y,
						gameArrays.numberOfLampsOnScreen[y].radius
					);
			...
			for (h = 0; h < gameArrays.monsterArray.length; h++) {
				if (gameArrays.monsterArray[h].state != 'idle') {
					if (gameArrays.monsterArray[h].skin === 1) {
						drawRotatedMonster(
							monster1HeatAttack,
							gameArrays.monsterArray[h].x,
							gameArrays.monsterArray[h].y,
							gameArrays.monsterArray[h].angle - 180,
							30,
							30,
							gameArrays.monsterArray[h].state
						);
		...
		if (hero.gun === 'pistol') {
			document.getElementById('gameClip').innerHTML =
				...
				' / ' +
				hero.gunshots +
				"<br><span class='smallTextForUtilities'>Ammo</span>";
		} else if (hero.gun === 'machete') {
			document.getElementById('gameClip').innerHTML =
				'<strong>' + '&infin;' + '</strong>' + "<br><span class='smallTextForUtilities'>Ammo</span>";
			...
			document.getElementById('gameClip').innerHTML =
				'<strong>' + hero.flameshells + '</strong>' + "<br><span class='smallTextForUtilities'>Ammo</span>";
		} else {
		}
		...
		document.getElementById('gameHealth').innerHTML =
			hero.health + "<br><span class='smallTextForUtilities'>Health</span>";
		...
		for (j = 0; j < gameArrays.thrownGranadeArray.length; j++) {
			thrownGranade(
				gameArrays.thrownGranadeArray[j],
				gameVariables.timeControler,
				gameArrays.monsterArray,
				gameArrays.archivedMonsterArray,
				hero,
		...
		for (y = 0; y < gameArrays.thrownGranadeArray.length; y++) {
			if (gameArrays.thrownGranadeArray[y].explosion === 1) {
				...
				ctx.drawImage(
					explosionImage,
					gameArrays.thrownGranadeArray[y].x - 125 / gameArrays.thrownGranadeArray[y].explosionExpansion,
					gameArrays.thrownGranadeArray[y].y - 125 / gameArrays.thrownGranadeArray[y].explosionExpansion,
					250 / gameArrays.thrownGranadeArray[y].explosionExpansion,
					250 / gameArrays.thrownGranadeArray[y].explosionExpansion
				);
				ctx.globalAlpha = 1;
				...
				if (gameVariables.timeControler.getTime() > gameArrays.thrownGranadeArray[y].explosionTime) {
					...
					gameArrays.thrownGranadeArray.splice(
						gameArrays.thrownGranadeArray[gameArrays.thrownGranadeArray.length - 1],
						1
					);
				}
			}
		...
		if (
			gameVariables.missionHighlight + 6000 > gameVariables.timeControler.getTime() &&
